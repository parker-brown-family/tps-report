...
[data-theme="hacker"] .copybar p{font-family:"Share Tech Mono","Courier New",monospace!important;font-size:12px!important;font-weight:700!important;color:#1a1500!important;text-shadow:none!important;letter-spacing:.18em;text-transform:uppercase;background:linear-gradient(180deg,#c9a82a 0%,#a78718 50%,#7c6210 100%);padding:7px 14px 6px;border:1px solid #4a3a08;box-shadow:inset 0 1px 0 rgba(255,235,150,.35),inset 0 -1px 0 rgba(0,0,0,.4),0 2px 4px rgba(0,0,0,.55);transform:rotate(-.6deg);max-width:62%}
